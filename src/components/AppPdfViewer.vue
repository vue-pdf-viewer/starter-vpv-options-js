<script>
  ...
  export default defineComponent({
    ...
    mounted() {
      // Call the `useLicense` hook with the license key inside the `mounted` lifecycle hook
      ...
      // which will trigger the watcher when the data is updated
...
<template>
  <div>
    ...
    <div v-if="isValidated" :style="{ width: '1028px', height: '700px', margin: '0 auto' }">
